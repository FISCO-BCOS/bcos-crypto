...
HsmSM2KeyPair::HsmSM2KeyPair(const std::string& _libPath, SecretPtr _secretKey) : HsmSM2KeyPair(_libPath)
{
...
HsmSM2KeyPair::HsmSM2KeyPair(const std::string& _libPath, unsigned int _keyIndex, const std::string& _password)
